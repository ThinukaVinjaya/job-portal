        ...
        <div className='w-2/3'>
            ...
            <div>
                ...
                <div className='flex flex-wrap gap-2'>
                    {
                        skills.map((item, index) => <ActionIcon key={index} color='bright-sun.4' className='!h-fit !text-sm !w-fit ' font-medium variant='light' p="xs" radius={'xl'} aria-label='Settings'>{item}
                        </ActionIcon>)
                    }
                </div>
            </div>

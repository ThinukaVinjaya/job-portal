...
const Profile = () => {
    ...
    return (
        <div className='w-4/5 mx-auto'>
            ...
            <Divider mx="xs" my="xl" />
            <div className='px-3'>
                <div className='text-2xl font-semibold mb-5 flex justify-between'>Experience<div className='flex gap-2'><ActionIcon onClick={() => setAddCerti(true)} size="lg" color='bright-sun.4' variant='subtle'>
                        <IconPlus className='h-4/5 w-4/5' /></ActionIcon>  
